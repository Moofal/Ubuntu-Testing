...
if (isset($_POST["reset-request-submit"])) {
	...
	if (empty($userEmail)) {
		header("location: ../StudentGlemtPassord.php?error=empty");
		exit();
	}
	...
	$url = "http://158.39.188.203/steg1/create-new-student-password.php?selector=".$selector."&validator".bin2hex($token);
	...
	header("Location: ../StudentGlemtPassord.php?reset=success");
